...
public strictfp class Range implements Serializable {
     ...
     * Note that:
     * <ul>
     * <li>either range can be <code>null</code>, in which case the other range
     * is returned;</li>
     ...
     * @param base the base range (<code>null</code> not permitted).
     * @param delta the shift amount.
     * @param allowZeroCrossing a flag that determines whether or not the bounds
     * of the range are allowed to cross zero after adjustment.
     *
     * @return A new range.
     */
    public static Range shift(Range base, double delta,
