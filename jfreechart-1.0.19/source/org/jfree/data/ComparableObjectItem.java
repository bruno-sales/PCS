...
public class ComparableObjectItem implements Cloneable, Comparable,
    ...
    /**
     * Sets the y-value for this data item. Note that there is no corresponding
     * method to change the x-value.
     *
     ...
     *
     * @return An integer indicating the order of this data pair object relative
     * to another object.
     */
    @Override
