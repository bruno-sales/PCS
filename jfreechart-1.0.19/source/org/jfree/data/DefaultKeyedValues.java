...
public class DefaultKeyedValues implements KeyedValues, Cloneable,
    ...
    /**
     * Contains (key, Integer) mappings, where the Integer is the index for the
     * key in the list.
     */
     ...
     *
     * @param index the index of the item to remove (in the range <code>0</code>
     * to <code>getItemCount() - 1</code>).
     *
     * @throws IndexOutOfBoundsException if <code>index</code> is not within the
     * specified range.
     */
