...
public abstract class DataUtilities {
     ...
     * match (two values that qre both NaN or both INF are considered equal in
     * this test).
     *
    ...
    /**
     * Returns the total of the values in one row of the supplied data table by
     * taking only the column numbers in the array into account.
     *
     * @param data the table of values (<code>null</code> not permitted).
     * @param row the row index (zero-based).
