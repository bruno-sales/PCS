...
public class KeyToGroupMap implements Cloneable, PublicCloneable, Serializable {
     ...
     *
     * @return The group index (or -1 if the group is not represented within the
     * map).
     */
     ...
     *
     * @param key the key (<code>null</code> not permitted).
     * @param group the group (<code>null</code> permitted, clears any existing
     * mapping).
     */
     ...
     * @return A clone.
     *
     * @throws CloneNotSupportedException if there is a problem cloning the map.
     */
    @Override
