...
public class KeyedObjects implements Cloneable, PublicCloneable, Serializable {
    ...
    /**
     * Replaces an existing object, or adds a new object to the collection. This
     * is the same as the {@link #addObject(Comparable, Object)} method.
     *
     * @param key the key (<code>null</code> not permitted).
     * @param object the object.
     *
    ...
    /**
     * Inserts a new value at the specified position in the dataset or, if there
     * is an existing item with the specified key, updates the value for that
     * item and moves it to the specified position.
     *
    ...
    /**
     * Returns a clone of this object. Keys in the list should be immutable and
     * are not cloned. Objects in the list are cloned only if they implement
     * {@link PublicCloneable}.
     *
     * @return A clone.
     *
