...
/**
 * An event that can be forwarded to any {@link MarkerChangeListener} to signal
 * a change to a {@link Marker}.
 *
 * @since 1.0.3
 */
public class MarkerChangeEvent extends ChartChangeEvent {
     ...
     *
     * @param marker the marker that triggered the event (<code>null</code> not
     * permitted).
     *
     * @since 1.0.3
     */
