...
public class XYPolygonAnnotation extends AbstractXYAnnotation
    ...
    /**
     * Creates a new annotation (where, by default, the polygon is drawn with a
     * black outline). The array of polygon coordinates must contain an even
     * number of coordinates (each pair is an (x, y) location on the plot) and
     * the last point is automatically joined back to the first point.
     *
     ...
     * specified <code>stroke</code> and <code>outlinePaint</code>. The array of
     * polygon coordinates must contain an even number of coordinates (each pair
     * is an (x, y) location on the plot) and the last point is automatically
     * joined back to the first point.
     *
     * @param polygon the coordinates of the polygon's vertices
     * (<code>null</code> not permitted).
    ...
    /**
     * Creates a new annotation. The array of polygon coordinates must contain
    ...
    /**
     * Returns the coordinates of the polygon's vertices. The returned array is
     * a copy, so it is safe to modify without altering the annotation's state.
     *
