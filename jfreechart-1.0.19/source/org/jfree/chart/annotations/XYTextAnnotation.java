...
public class XYTextAnnotation extends AbstractXYAnnotation
    ...
    /**
     * Sets the rotation anchor point and sends an {@link AnnotationChangeEvent}
    ...
    /**
     * Sets the rotation angle and sends an {@link AnnotationChangeEvent} to all
     * registered listeners. The angle is measured clockwise in radians.
     *
    ...
    /**
     * Sets the flag that controls whether or not the outline is drawn and sends
     * an {@link AnnotationChangeEvent} to all registered listeners.
     *
     ...
     * @param info an optional info object that will be populated with entity
     * information.
     */
    @Override
