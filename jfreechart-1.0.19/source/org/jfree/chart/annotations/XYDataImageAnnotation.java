 ...
 * in data coordinates on an {@link XYPlot}. Note that this annotation is not
 * currently serializable, so don't use it if you plan on serializing your
 * chart(s).
 *
 * @since 1.0.11
 */
public class XYDataImageAnnotation extends AbstractXYAnnotation
    ...
    /**
     * A flag indicating whether or not the annotation should contribute to the
     * data range for a plot/renderer.
     *
     * @since 1.0.13
     */
