...
public abstract class AbstractAnnotation implements Annotation, Cloneable,
     ...
     * annotation as a listener. Most applications won't need to call this
    ...
    /**
     * Returns a flag that indicates whether listeners should be notified about
     * changes to the annotation.
     *
     * @return the flag.
     *
    ...
    /**
     * Returns a clone of the annotation. The cloned annotation will NOT include
     * the {@link AnnotationChangeListener} references that have been registered
