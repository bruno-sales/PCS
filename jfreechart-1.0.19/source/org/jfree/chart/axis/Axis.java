...
public abstract class Axis implements Cloneable, Serializable {
    ...
    /**
     * An attributed label for the axis (overrides label if non-null). We have
     * to use this override method to preserve the API compatibility.
     */
    ...
    /**
     * Returns the attributed label (the returned value is a copy, so modifying
     * it will not impact the state of the axis). The default value is
     * {@code null}.
     *
