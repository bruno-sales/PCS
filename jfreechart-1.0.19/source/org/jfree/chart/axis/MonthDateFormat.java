...
public class MonthDateFormat extends DateFormat {
     ...
     * Creates a new instance for the specified time zone.
     *
     * @param locale the locale used to obtain the month names
     ...
     *
     * @param zone the time zone (<code>null</code> not permitted).
     * @param chars the maximum number of characters to use from the month names
     * (that are obtained from the date symbols of the default locale). If this
     * value is &lt;= 0, the entire month name is used in each case.
     */
     ...
     * names, or zero to indicate that the entire month name should be used.
     * @param showYearForJan a flag that controls whether or not the year is
     * appended to the symbol for the first month of each year.
     * @param showYearForDec a flag that controls whether or not the year is
     * appended to the symbol for the last month of each year.
     */
     ...
     * @param chars the maximum number of characters to use from the month
     * names, or zero to indicate that the entire month name should be used.
     * @param showYear an array of flags that control whether or not the year is
