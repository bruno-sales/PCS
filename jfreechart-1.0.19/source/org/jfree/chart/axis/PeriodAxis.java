 ...
 * {@link org.jfree.data.time.RegularTimePeriod}. This axis works when displayed
 * across the bottom or top of a plot, but is broken for display at the left or
 * right of charts.
 */
public class PeriodAxis extends ValueAxis
     ...
     * @param first the first time period in the axis range (<code>null</code>
     * not permitted).
     * @param last the last time period in the axis range (<code>null</code> not
     * permitted).
     */
    public PeriodAxis(String label,
    ...
    /**
     * Returns the time zone used to convert the periods defining the axis range
    ...
    /**
     * Sets the time zone that is used to convert the time periods into absolute
     * milliseconds.
     *
    ...
    /**
     * Returns the class used to create the first and last time periods for the
     * axis range when the auto-range flag is set to <code>true</code>.
     *
     ...
     * axis range when the auto-range flag is set to <code>true</code> and sends
     ...
     *
     * @param c the class (a subclass of {@link RegularTimePeriod} is expected).
     */
    ...
    /**
     * Returns the flag that controls whether or not minor tick marks are
     * displayed for the axis.
     *
     * @return A boolean.
     */
    @Override
    ...
    /**
     * Sets the flag that controls whether or not minor tick marks are displayed
     * for the axis, and sends a {@link AxisChangeEvent} to all registered
     * listeners.
     *
    ...
    /**
     * Sets the stroke used to display minor tick marks, if they are visible,
     * and sends a {@link AxisChangeEvent} to all registered listeners.
     *
    ...
    /**
     * Sets the paint used to display minor tick marks, if they are visible, and
     * sends a {@link AxisChangeEvent} to all registered listeners.
     *
    ...
    /**
     * Sets the array of label info records and sends an {@link AxisChangeEvent}
     ...
     * @param plotArea the area within which the plot (including axes) should be
     * drawn.
