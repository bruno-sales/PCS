...
public class ExtendedCategoryAxis extends CategoryAxis {
    ...
    /**
     * Sets the paint for the sublabels and sends an {@link AxisChangeEvent} to
     * all registered listeners.
     *
    ...
    /**
     * Overrides the default behaviour by adding the sublabel to the text block
     * that is used for the category label.
     *
     * @param category the category.
