...
public class DateTickUnit extends TickUnit implements Serializable {
     ...
     * unit count.
     * <P>
     * This value is an approximation some of the time (e.g. months are assumed
     * to have 31 days) but this shouldn't matter.
     *
     * @param unit the unit.
    ...
    /**
     * Creates a new date tick unit. You can specify the units using one of the
     * constants YEAR, MONTH, DAY, HOUR, MINUTE, SECOND or MILLISECOND. In
     * addition, you can specify a unit count, and a date format.
     *
     * @param unit the unit.
     * @param count the unit count.
