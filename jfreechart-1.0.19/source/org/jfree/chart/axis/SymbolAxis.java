...
public class SymbolAxis extends NumberAxis implements Serializable {
    ...
    /**
     * Sets the visibility of the grid bands and notifies registered listeners
     ...
     * <CODE>gridBandPaint</CODE>. False: the second grid band takes the color
     * of <CODE>gridBandPaint</CODE>.
    ...
    /**
     * Draws the grid bands for an axis that is aligned to the left or right of
     * the data area (that is, a vertical axis).
     *
     * @param g2 the graphics target (<code>null</code> not permitted).
     * @param plotArea the area within which the plot is drawn (not used here).
     * @param dataArea the area for the data (to which the axes are aligned,
