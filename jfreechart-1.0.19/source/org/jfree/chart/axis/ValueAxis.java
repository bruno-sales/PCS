...
public abstract class ValueAxis extends Axis
     ...
     *
     * @deprecated From 1.0.5 onwards, the axis defines a defaultRange attribute
     * (see {@link #getDefaultAutoRange()}).
     */
     ...
     * @param edge the edge that the axis is aligned with (<code>null</code> not
     * permitted).
     *
     ...
     * @param vertical a flag that indicates whether or not the tick labels are
     * 'vertical'.
     *
