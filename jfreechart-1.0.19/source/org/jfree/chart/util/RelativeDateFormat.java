...
/**
 * A formatter that formats dates to show the elapsed time relative to some base
 * date.
 *
 * @since 1.0.3
 */
public class RelativeDateFormat extends DateFormat {
    ...
    /**
     * A formatter for the day count (most likely not critical until the day
     * count exceeds 999).
     */
    ...
    /**
     * Returns the flag that controls whether or not zero day counts are shown
    ...
    /**
     * Sets the flag that controls whether or not zero day counts are shown in
    ...
    /**
     * Returns the flag that controls whether or not zero hour counts are shown
     * in the formatted output.
     *
     * @return The flag.
     *
    ...
    /**
     * Sets the flag that controls whether or not zero hour counts are shown in
     * the formatted output.
     *
     * @param show the flag.
     *
