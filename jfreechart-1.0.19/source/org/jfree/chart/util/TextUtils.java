...
public class TextUtils {
     ...
     * given <code>(x, y)</code> location, and returns a bounding rectangle for
     * the text.
     *
     * @param text the text.
     ...
     * @param text the text.
     * @param anchor the anchor point.
     * @param textBounds the text bounds (if not <code>null</code>, this object
     * will be updated by this method to match the string bounds).
     *
     * @return The offsets.
     */
    private static float[] deriveTextBoundsAnchorOffsets(Graphics2D g2,
    ...
    /**
     * Returns the bounds for the specified text. The supplied text is assumed
     * to be on a single line (no carriage return or newline characters).
     *
