...
/**
 * Collection of utility methods related to producing image maps. Functionality
 * was originally in {@link org.jfree.chart.ChartUtilities}.
 */
public class ImageMapUtilities {
    ...
    /**
     * Returns a string that is equivalent to the input string, but with special
     * characters converted to HTML escape sequences.
     *
    ...
    /**
     * Returns a string that is equivalent to the input string, but with special
     * characters converted to JavaScript escape sequences.
     *
     * @param input the string to escape (<code>null</code> not permitted).
     *
     * @return A string with characters escaped.
