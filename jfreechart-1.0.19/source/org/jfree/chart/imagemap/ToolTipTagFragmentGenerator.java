...
public interface ToolTipTagFragmentGenerator {
     ...
     * varying standards compliance among browsers, this method is expected to
     * return an 'alt' attribute IN ADDITION TO whatever it does to create the
     * tooltip (often a 'title' attribute).
     * <br><br>
