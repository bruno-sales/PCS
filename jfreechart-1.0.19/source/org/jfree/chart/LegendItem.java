...
public class LegendItem implements Cloneable, Serializable {
     ...
     * @param fillPaint the paint used to fill the shape ({@code null} not
     * permitted).
     */
     ...
     * @param fillPaint the paint used to fill the shape ({@code null} not
     * permitted).
     * @param outlineStroke the outline stroke ({@code null} not permitted).
     ...
     *
     * @param label the label ({@code null} not permitted).
     * @param description the description (not currently used, <code>null</code>
     * permitted).
     ...
     * @param shapeOutlineVisible a flag that controls whether or not the shape
     * is outlined.
     ...
     * @param fillPaint the paint used to fill the shape (<code>null</code> not
     * permitted).
     */
