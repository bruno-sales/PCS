...
public abstract class ChartUtilities {
    ...
    /**
     * Applies the current theme to the specified chart. This method is provided
     * for convenience, the theme itself is stored in the {@link ChartFactory}
     * class.
     *
    ...
    /**
     * Writes a chart to an output stream in PNG format. This method allows you
     * to pass in a {@link ChartRenderingInfo} object, to collect information
     * about the chart dimensions/entities. You will need this info if you want
    ...
    /**
     * Saves a chart to a file in PNG format. This method allows you to pass in
     * a {@link ChartRenderingInfo} object, to collect information about the
     * chart dimensions/entities. You will need this info if you want to create
     * an HTML image map.
     *
    ...
    /**
     * Writes a chart to an output stream in JPEG format. Please note that JPEG
    ...
    /**
     * Writes a chart to an output stream in JPEG format. This method allows you
     * to pass in a {@link ChartRenderingInfo} object, to collect information
     * about the chart dimensions/entities. You will need this info if you want
     * to create an HTML image map.
     *
    ...
    /**
     * Saves a chart to a file in JPEG format. This method allows you to pass in
     * a {@link ChartRenderingInfo} object, to collect information about the
     * chart dimensions/entities. You will need this info if you want to create
     * an HTML image map.
     *
     ...
     * @param name the map name (<code>null</code> not permitted).
     * @param info the chart rendering info (<code>null</code> not permitted).
     * @param toolTipTagFragmentGenerator a generator for the HTML fragment that
     * will contain the tooltip text (<code>null</code> not permitted if
     * <code>info</code> contains tooltip information).
    ...
    /**
     * Creates an HTML image map. This method maps to      {@link ImageMapUtilities#getImageMap(String, ChartRenderingInfo,
    ...
    /**
     * Creates an HTML image map. This method maps directly to      {@link ImageMapUtilities#getImageMap(String, ChartRenderingInfo,
     * ToolTipTagFragmentGenerator, URLTagFragmentGenerator)}.
     *
     * @param name the map name (<code>null</code> not permitted).
     * @param info the chart rendering info (<code>null</code> not permitted).
