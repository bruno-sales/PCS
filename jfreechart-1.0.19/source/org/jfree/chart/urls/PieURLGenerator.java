 ...
 * dataset, as this may be user-specified and could pose a security risk;</li>
 * <li>should be either (a) immutable, or (b) cloneable via the
 * <code>PublicCloneable</code> interface (defined in the JCommon class
 * library). This provides a mechanism for the referring plot to clone the
 * generator if necessary.</li>
 * </ul>
 */
public interface PieURLGenerator {

    /**
     * Generates a URL for one item in a {@link PieDataset}. As a guideline, the
     * URL should be valid within the context of an XHTML 1.0 document.
     *
     * @param dataset the dataset (<code>null</code> not permitted).
     * @param key the item key (<code>null</code> not permitted).
     * @param pieIndex the pie index (differentiates between pies in a 'multi'
     * pie chart).
     *
