...
public class HashUtilities {
    ...
    /**
     * Returns a hash code for a <code>Paint</code> instance. If <code>p</code>
    ...
    /**
     * Returns a hash code for a <code>double[]</code> instance. If the array is
     * <code>null</code>, this method returns zero.
     *
    ...
    /**
     * Computes a hash code for a {@link BooleanList}. In the latest version of
     * JCommon, the {@link BooleanList} class should implement the hashCode()
    ...
    /**
     * Computes a hash code for a {@link PaintList}. In the latest version of
     * JCommon, the {@link PaintList} class should implement the hashCode()
     * method correctly, but we compute it here anyway so that we can work with
     * older versions of JCommon (back to 1.0.0).
     *
     * @param pre the seed value.
    ...
    /**
     * Computes a hash code for a {@link StrokeList}. In the latest version of
     * JCommon, the {@link StrokeList} class should implement the hashCode()
     * method correctly, but we compute it here anyway so that we can work with
     * older versions of JCommon (back to 1.0.0).
     *
     * @param pre the seed value.
