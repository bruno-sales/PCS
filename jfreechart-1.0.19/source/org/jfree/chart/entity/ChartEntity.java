...
public class ChartEntity implements Cloneable, PublicCloneable, Serializable {
     ...
     * will contain the tooltip text (<code>null</code> not permitted if this
     * entity contains tooltip information).
     * @param urlTagFragmentGenerator a generator for the HTML fragment that
     * will contain the URL reference (<code>null</code> not permitted if this
     * entity has a URL).
     *
     * @return The HTML tag.
     */
