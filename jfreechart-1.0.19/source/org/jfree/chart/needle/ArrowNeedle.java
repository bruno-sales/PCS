...
public class ArrowNeedle extends MeterNeedle
     ...
     *
     * @param isArrowAtTop a flag that controls whether or not there is an arrow
     ...
     * @return A clone.
     *
     * @throws CloneNotSupportedException if the <code>ArrowNeedle</code> cannot
     * be cloned (in theory, this should not happen).
     */
    @Override
