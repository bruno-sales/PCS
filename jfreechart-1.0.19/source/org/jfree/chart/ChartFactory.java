...
public abstract class ChartFactory {
    ...
    /**
     * Creates a pie chart with default settings that compares 2 datasets. The
     * colour of each section will be determined by the move from the value for
     * the same key in <code>previousDataset</code>. ie if value1 &gt; value2
     * then the section will be in green (unless <code>greenForIncrease</code>
     * is <code>false</code>, in which case it would be <code>red</code>). Each
     * section can have a shade of red or green as the difference can be
     * tailored between 0% (black) and percentDiffForMaxScale% (bright
     * red/green).
     * <p>
     * For instance if <code>percentDiffForMaxScale</code> is 10 (10%), a
     * difference of 5% will have a half shade of red/green, a difference of 10%
     * or more will have a maximum shade/brightness of red/green.
     * <P>
     * The chart object returned by this method uses a {@link PiePlot} instance
     * as the plot.
     * <p>
     ...
     * @param title the chart title (<code>null</code> permitted).
     * @param dataset the dataset for the chart (<code>null</code> permitted).
     * @param previousDataset the dataset for the last run, this will be used to
     * compare each key in the dataset
     * @param percentDiffForMaxScale scale goes from bright red/green to black,
     * percentDiffForMaxScale indicate the change required to reach top scale.
     ...
     * <P>
     * The chart object returned by this method uses a {@link RingPlot} instance
     * as the plot.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param dataset the dataset for the chart (<code>null</code> permitted).
     ...
     * returned by this method uses a {@link PiePlot3D} instance as the plot.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param dataset the dataset for the chart (<code>null</code> permitted).
     * @param legend a flag specifying whether or not a legend is required.
     ...
     * returned by this method uses a {@link CategoryPlot} instance as the plot,
     * with a {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as
     * the range axis, and a {@link BarRenderer} as the renderer.
     *
     * @param title the chart title (<code>null</code> permitted).
     ...
     * returned by this method uses a {@link CategoryPlot} instance as the plot,
     * with a {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as
     * the range axis, and a {@link StackedBarRenderer} as the renderer.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param domainAxisLabel the label for the category axis (<code>null</code>
     * permitted).
     * @param rangeAxisLabel the label for the value axis (<code>null</code>
     * permitted).
     * @param dataset the dataset for the chart (<code>null</code> permitted).
     *
     ...
     * {@link CategoryAxis3D} for the domain axis, a {@link NumberAxis3D} as the
     ...
     * chart object returned by this method uses a {@link CategoryPlot} instance
     * as the plot, with a {@link CategoryAxis3D} for the domain axis, a
     * {@link NumberAxis3D} as the range axis, and a
    ...
    /**
     * Creates an area chart with default settings. The chart object returned by
     ...
     * returned by this method uses a {@link CategoryPlot} instance as the plot,
     * with a {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as
     * the range axis, and a {@link StackedAreaRenderer} as the renderer.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param categoryAxisLabel the label for the category axis
     * (<code>null</code> permitted).
     ...
     * this method uses a {@link CategoryPlot} instance as the plot, with a
     * {@link CategoryAxis3D} for the domain axis, a {@link NumberAxis3D} as the
     * range axis, and a {@link LineRenderer3D} as the renderer.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param categoryAxisLabel the label for the category axis
     * (<code>null</code> permitted).
     ...
     * @param categoryAxisLabel the label for the category axis
     * (<code>null</code> permitted).
     * @param dateAxisLabel the label for the date axis (<code>null</code>
     * permitted).
     * @param dataset the dataset for the chart (<code>null</code> permitted).
     *
    ...
    /**
     * Creates a waterfall chart. The chart object returned by this method uses
     * a {@link CategoryPlot} instance as the plot, with a {@link CategoryAxis}
     * for the domain axis, a {@link NumberAxis} as the range axis, and a
     * {@link WaterfallBarRenderer} as the renderer.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param categoryAxisLabel the label for the category axis
     * (<code>null</code> permitted).
     ...
     * {@link PolarPlot} instance as the plot, with a {@link NumberAxis} for the
     * radial axis.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param dataset the dataset (<code>null</code> permitted).
    ...
    /**
     * Creates a scatter plot with default settings. The chart object returned
     * by this method uses an {@link XYPlot} instance as the plot, with a
     * {@link NumberAxis} for the domain axis, a {@link NumberAxis} as the range
     * axis, and an {@link XYLineAndShapeRenderer} as the renderer.
     *
     * @param title the chart title (<code>null</code> permitted).
     ...
     * {@link NumberAxis} as the range axis, and a {@link XYAreaRenderer} as the
     * renderer.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param xAxisLabel a label for the X-axis (<code>null</code> permitted).
    ...
    /**
     * Creates a stacked XY area plot. The chart object returned by this method
     * uses an {@link XYPlot} instance as the plot, with a {@link NumberAxis}
     * for the domain axis, a {@link NumberAxis} as the range axis, and a
     * {@link StackedXYAreaRenderer2} as the renderer.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param xAxisLabel a label for the X-axis (<code>null</code> permitted).
     * @param yAxisLabel a label for the Y-axis (<code>null</code> permitted).
     ...
     * {@link org.jfree.chart.axis.SegmentedTimeline} such as the Monday through
     * Friday timeline that will remove Saturdays and Sundays from the axis.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param timeAxisLabel a label for the time axis (<code>null</code>
     * permitted).
    ...
    /**
     * Creates a bubble chart with default settings. The chart is composed of an
     * {@link XYPlot}, with a {@link NumberAxis} for the domain axis, a
     * {@link NumberAxis} for the range axis, and an {@link XYBubbleRenderer} to
     * draw the data items.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param xAxisLabel a label for the X-axis (<code>null</code> permitted).
     ...
     * {@link XYPlot} using an {@link XYBarRenderer}. The domain and range axes
     * are {@link NumberAxis} instances.
     *
     * @param title the chart title (<code>null</code> permitted).
    ...
    /**
     * Creates and returns a default instance of a box and whisker chart based
     * on data from a {@link BoxAndWhiskerCategoryDataset}.
     *
     * @param title the chart title (<code>null</code> permitted).
     * @param categoryAxisLabel a label for the category axis (<code>null</code>
     * permitted).
     * @param valueAxisLabel a label for the value axis (<code>null</code>
     * permitted).
     * @param dataset the dataset for the chart (<code>null</code> permitted).
