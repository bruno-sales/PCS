...
/**
 * A base class for handling the distribution of pie section labels. Create your
 * own subclass and set it using the
 * {@link PiePlot#setLabelDistributor(AbstractPieLabelDistributor)} method if
 * you want to customise the label distribution.
 */
