 ...
 * <ol>
 * <li>three sub-ranges which could be viewed as 'Normal', 'Warning' and
 * 'Critical' ranges.</li>
...
public class ThermometerPlot extends Plot implements ValueAxisPlot,
     ...
     * one, and sends a {@link PlotChangeEvent} to all registered listeners.
     *
     ...
     * {@link PlotChangeEvent} to all registered listeners.
     * <P>
     * The location can be one of the constants: <code>NONE</code>,
    ...
    /**
     * Sets the default mercury paint and sends a {@link PlotChangeEvent} to all
     ...
     *
     * @deprecated This flag doesn't do anything useful/visible. Deprecated as
     * of version 1.0.6.
     */
    ...
    /**
     * Returns the bulb diameter, which is always twice the value returned by
     * {@link #getBulbRadius()}.
     *
    ...
    /**
     * Returns the column diameter, which is always twice the value returned by
     * {@link #getColumnRadius()}.
     *
    ...
    /**
     * Returns the gap, in Java2D units, between the two outlines that represent
     * the thermometer.
     *
     * @return The gap.
     *
     ...
     * operation. In the case of a thermometer chart, it doesn't make sense to
    ...
    /**
     * Returns the mercury paint corresponding to the current data value. Called
     * from the {@link #draw(Graphics2D, Rectangle2D, Point2D,
    ...
    /**
     * Tests this plot for equality with another object. The plot's dataset is
