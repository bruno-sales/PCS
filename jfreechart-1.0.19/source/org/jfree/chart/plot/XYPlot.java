...
public class XYPlot extends Plot implements ValueAxisPlot, Pannable, Zoomable,
    ...
    /**
     * Returns the range axis with the specified index, or {@code null} if there
     * is no axis with that index.
     *
     * @param index the axis index (must be &gt;= 0).
     *
     * @return The axis ({@code null} possible).
    ...
    /**
     * Returns the dataset with the specified index, or {@code null} if there is
     * no dataset with that index.
     *
    ...
    /**
     * Returns the index of the specified dataset, or {@code -1} if the dataset
    ...
    /**
     * Sets the renderer for the primary dataset and sends a change event to all
     * registered listeners. If the renderer is set to <code>null</code>, no
     ...
     * renderer with the same index as the dataset or, if there isn't a renderer
     * with the same index, the default renderer). If the dataset does not
     ...
     * @param index the dataset/renderer index.
     * @param marker the marker (<code>null</code> not permitted).
     * @param layer the layer (foreground or background) (<code>null</code> not
     * permitted).
     * @param notify notify listeners?
     *
     * @return A boolean indicating whether or not the marker was actually
    ...
    /**
     * Returns {@code true} if panning is enabled for the range axis/axes, and
