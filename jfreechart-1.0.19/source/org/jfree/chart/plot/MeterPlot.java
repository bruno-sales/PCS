...
public class MeterPlot extends Plot implements Serializable, Cloneable {
    ...
    /**
     * Sets the dial shape and sends a {@link PlotChangeEvent} to all registered
     * listeners.
     *
    ...
    /**
     * Returns the meter angle in degrees. This defines, in part, the shape of
     * the dial. The default is 270 degrees.
     *
    ...
    /**
     * Sets the tick size and sends a {@link PlotChangeEvent} to all registered
     * listeners.
     *
    ...
    /**
     * Returns a flag that controls whether or not a rectangular border is drawn
     ...
     * one, and triggers a {@link PlotChangeEvent}.
     *
     * @param dataset the dataset (<code>null</code> permitted).
     *
     * @see #getDataset()
     ...
     * operation. In the case of a meter plot, it doesn't make sense to zoom in
     * or out, so the method is empty.
     *
