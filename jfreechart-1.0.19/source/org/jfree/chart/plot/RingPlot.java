...
public class RingPlot extends PiePlot implements Cloneable, Serializable {
    ...
    /**
     * The formatter used when displaying the first data value from the dataset
    ...
    /**
     * The length of the inner separator extension (as a percentage of the depth
     * of the sections).
     */
    private double innerSeparatorExtension;

    /**
     * The length of the outer separator extension (as a percentage of the depth
     * of the sections).
     */
     ...
     * default value is {@link CenterTextMode#NONE} therefore no text will be
    ...
    /**
     * Sets the mode for displaying text in the center of the plot and sends a
     * change event to all registered listeners. For
     * {@link CenterTextMode#FIXED}, the display text will come from the
     * <code>centerText</code> attribute (see {@link #getCenterText()}). For
     * {@link CenterTextMode#VALUE}, the center text will be the value from the
     * first section in the dataset.
     *
    ...
    /**
     * Returns the text to display in the center of the plot when the mode is
     * {@link CenterTextMode#FIXED}.
     *
    ...
    /**
     * Sets the text to display in the center of the plot and sends a change
     * event to all registered listeners. If the text is set to
    ...
    /**
     * Returns the font used to display the center text. The default value is
     * {@link PiePlot#DEFAULT_LABEL_FONT}.
     *
    ...
    /**
     * Sets the font used to display the center text and sends a change event to
    ...
    /**
     * Sets the stroke used to draw the separator between sections and sends a
     * change event to all registered listeners.
     *
    ...
    /**
     * Returns the length of the inner extension of the separator line that is
     * drawn between sections, expressed as a percentage of the depth of the
     * section.
     *
     ...
     * drawn between sections, as a percentage of the depth of the sections, and
    ...
    /**
     * Returns the length of the outer extension of the separator line that is
     * drawn between sections, expressed as a percentage of the depth of the
     * section.
     *
    ...
    /**
     * Returns the depth of each section, expressed as a percentage of the plot
     * radius.
     *
    ...
    /**
     * The section depth is given as percentage of the plot radius. Specifying
     * 1.0 results in a straightforward pie chart.
     *
     ...
     * values, among other things). This method is called once at the beginning
     * of each drawing.
     *
    ...
    /**
     * This method overrides the default value for cases where the ring plot is
     * very thin. This fixes bug 2121818.
     *
