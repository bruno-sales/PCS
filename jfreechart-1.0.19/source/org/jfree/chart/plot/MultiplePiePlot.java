...
public class MultiplePiePlot extends Plot implements Cloneable, Serializable {
    ...
    /**
     * Returns the pie chart that is used to draw the individual pie plots. Note
     * that there are some attributes on this chart instance that will be
     * ignored at rendering time (for example, legend item settings).
     *
    ...
    /**
     * Sets the chart that is used to draw the individual pie plots. The chart's
     * plot must be an instance of {@link PiePlot}.
     *
    ...
    /**
     * Sets the limit below which pie sections are aggregated. Set this to 0.0
     * if you don't want any aggregation to occur.
     *
    ...
    /**
     * Sets the key for aggregated items in the pie plots. You must ensure that
     * this doesn't clash with any keys in the dataset.
     *
     ...
     * the drawing supplier. These colors are cached so that the legend and all
     * the subplots use consistent colors.
     */
