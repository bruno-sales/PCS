...
public class PiePlotState extends RendererState {
    ...
    /**
     * Sets the y-coordinate of the center of the pie chart. This method is used
     * by the plot and typically is not called directly by applications.
     *
    ...
    /**
     * Sets the label link area. This defines the "dog-leg" point for the label
     * linking lines.
     *
     * @param area the area.
     */
