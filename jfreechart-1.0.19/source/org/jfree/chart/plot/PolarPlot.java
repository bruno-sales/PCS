...
public class PolarPlot extends Plot implements ValueAxisPlot, Zoomable,
    ...
    /**
     * Sets the primary axis for the plot and sends a {@link PlotChangeEvent} to
    ...
    /**
     * Sets the location of the primary axis and sends a {@link PlotChangeEvent}
    ...
    /**
     * Sets the location for an axis and sends a {@link PlotChangeEvent} to all
     * registered listeners.
     *
     * @param index the axis index.
     * @param location the location (<code>null</code> not permitted).
     ...
     * there is one, and sends a {@code link PlotChangeEvent} to all registered
     * listeners.
     *
     * @param dataset the dataset (<code>null</code> permitted).
     *
     ...
     * plot. If the renderer is set to <code>null</code>, no data items will be
     * drawn for the corresponding dataset.
     *
    ...
    /**
     * Sets a renderer and, if requested, sends a {@link PlotChangeEvent} to all
     * registered listeners.
     *
     * @param index the index.
     * @param renderer the renderer.
    ...
    /**
     * Sets the tick unit that controls the spacing of the angular grid lines,
     ...
     * {@link PlotChangeEvent} to all registered listeners.
     *
     * This is useful to let 0 degrees be at the north, east, south or west side
     * of the chart.
     *
     ...
     *
     * <code>true</code> for counterclockwise, <code>false</code> for clockwise.
     *
    ...
    /**
     * Returns the paint for the grid lines (if any) plotted against the angular
     * axis.
     *
    ...
    /**
     * Sets the flag that controls whether or not the radius axis grid lines are
     * visible.
     * <p>
     * If the flag value is changed, a {@link PlotChangeEvent} is sent to all
     * registered listeners.
    ...
    /**
     * Returns the stroke for the grid lines (if any) plotted against the radius
     * axis.
     *
     * @return The stroke (possibly <code>null</code>).
     *
    ...
    /**
     * Set the margin around the plot area and sends a {@link PlotChangeEvent}
     * to all registered listeners.
     *
    ...
    /**
     * Remove the given text from the list of corner text items and sends a
     * {@link PlotChangeEvent} to all registered listeners.
     *
    ...
    /**
     * Maps a dataset to a particular axis. All data will be plotted against
     * axis zero by default, no mapping is required for this case.
     *
     ...
     * indices passed to mapDatasetToAxes().
     *
     ...
     * printer).
     * <P>
     * This plot relies on a {@link PolarItemRenderer} to draw each item in the
     ...
     * @param area the area within which the plot (including axes and labels)
     * should be drawn.
    ...
    /**
     * Create a list of ticks based on the given list and plot properties. Only
     * ticks of a specific type may be in the result list.
     *
    ...
    /**
     * This method is required by the {@link Zoomable} interface, but since the
     * plot does not have any domain axes, it does nothing.
     *
     ...
     * <code>radius</code> is less than the lower bound of the axis, then this
     * method returns the centre point.
     *
     * @param angleDegrees the angle in degrees.
    ...
    /**
     * Returns the number of series in the dataset for this plot. If the dataset
     * is <code>null</code>, the method returns 0.
     *
     * @return The series count.
     *
     * @deprecated Since 1.0.14, grab a reference to the dataset and check the
     * series count directly.
     */
