...
public class PiePlot3D extends PiePlot implements Serializable {
    ...
    /**
     * A flag that controls whether or not the sides of the pie chart are
     * rendered using a darker colour.
     *
     * @since 1.0.7.
     */
    ...
    /**
     * Sets a flag that controls whether or not the sides of the pie chart are
     * rendered using a darker colour, and sends a {@link PlotChangeEvent} to
