...
public class Crosshair implements Cloneable, PublicCloneable, Serializable {
    ...
    /**
     * Returns the flag that indicates whether or not the crosshair is currently
     * visible.
     *
     * @return A boolean.
     *
    ...
    /**
     * Sets the flag that controls the visibility of the crosshair and sends a
     * proerty change event (with the name 'visible') to all registered
     * listeners.
     *
