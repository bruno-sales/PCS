...
public class PiePlot extends Plot implements Cloneable, Serializable {
     ...
     *
     * @param key the section key.
     * @param autoPopulate a flag that controls whether the drawing supplier is
     * used to auto-populate the section paint settings.
     *
     * @return The paint.
     *
     * @since 1.0.3
     ...
     * auto-populated by the {@link #lookupSectionPaint(Comparable)} method, and
     ...
     * @param key the section key.
     * @param autoPopulate a flag that controls whether the drawing supplier is
     * used to auto-populate the section outline paint settings.
     *
     * @return The paint.
     *
     * @since 1.0.3
     ...
     * @param key the section key.
     * @param autoPopulate a flag that controls whether the drawing supplier is
     * used to auto-populate the section outline stroke settings.
     *
     * @return The stroke.
     *
     * @since 1.0.3
     ...
     * plot, expressed as a percentage of the plot's radius.
     * <br><br>
     ...
     * {@link PlotChangeEvent} to all registered listeners. Note that this is a
     * bitmap drop-shadow generation facility and is separate from the vector
     * based show option that is controlled via the
     ...
     * @param info collects info about the drawing (<code>null</code>
     * permitted).
     */
    @Override
     ...
     * section, in degrees) for the sections on the left side of the plot.
     * @param g2 the graphics device.
     * @param plotArea the plot area.
     * @param linkArea the link area.
    ...
    /**
     * Returns the center for the specified section. Checks to see if the
     * section is exploded and recalculates the new center if so.
     *
    ...
    /**
     * Returns the paint for the specified section. This is equivalent to
     * <code>lookupSectionPaint(section)</code>. Checks to see if the user set
     * the Paint to be of type RadialGradientPaint If so it adjusts the center
     * and radius to match the Pie
     *
     * @param key the section key.
     * @param state PiePlotState.
     *
     ...
     * sectionPaintMap and baseSectionPaint. Deprecated as of version 1.0.6.
     */
     ...
     *
     * @deprecated This field is redundant, it is sufficient to use
     * sectionOutlinePaintMap and baseSectionOutlinePaint. Deprecated as of
     * version 1.0.6.
     */
     ...
     *
     * @deprecated This field is redundant, it is sufficient to use
     * sectionOutlineStrokeMap and baseSectionOutlineStroke. Deprecated as of
     * version 1.0.6.
     */
     ...
     * {@link #getBaseSectionOutlinePaint()}. Deprecated as of version 1.0.6.
     */
     ...
     * {@link #setBaseSectionOutlinePaint(Paint)}. Deprecated as of version
     * 1.0.6.
     */
     ...
     * {@link #getBaseSectionOutlineStroke()}. Deprecated as of version 1.0.6.
     */
     ...
     * {@link #setBaseSectionOutlineStroke(Stroke)}. Deprecated as of version
     * 1.0.6.
     */
