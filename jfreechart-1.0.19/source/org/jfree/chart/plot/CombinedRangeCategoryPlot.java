...
public class CombinedRangeCategoryPlot extends CategoryPlot
     ...
     * printer). Will perform all the placement calculations for each sub-plots
     * and then tell these to draw themselves.
     *
     * @param g2 the graphics device.
     ...
     * range axis is shared between subplots, the JFreeChart code will only call
     * this method for the range values (although this is not checked/enforced).
     *
     * @param axis the axis.
     *
     * @return The range.
