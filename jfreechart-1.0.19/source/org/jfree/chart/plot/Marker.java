...
public abstract class Marker implements Cloneable, Serializable {
     ...
     *
     * @throws IllegalArgumentException if {@code paint} or {@code stroke} is
     * {@code null}, or {@code alpha} is not in the specified range.
     */
     ...
     * @param alpha the alpha transparency (must be in the range 0.0f to 1.0f).
     *
     * @throws IllegalArgumentException if {@code alpha} is not in the specified
     * range.
     *
     * @see #getAlpha()
     */
