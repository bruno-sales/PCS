...
public class CombinedDomainCategoryPlot extends CategoryPlot
     ...
     * unique categories from the overall union of the datasets...so the domain
     * axis is reconfigured, then a {@link PlotChangeEvent} is sent to all
     ...
     * for the range axis of each subplot.
     *
     ...
     * public only so that code in the axis classes can call it. Since, for this
     * class, the domain axis is a {@link CategoryAxis} (not a
     * {@code ValueAxis}) and subplots have independent range axes, the
     * JFreeChart code will never call this method (although this is not
     * checked/enforced).
     *
     * @param axis the axis.
     *
