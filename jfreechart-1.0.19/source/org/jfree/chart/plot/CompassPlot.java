...
public class CompassPlot extends Plot implements Cloneable, Serializable {
    ...
    /**
     * The count to complete one revolution. Can be arbitrarily set For degrees
    ...
    /**
     * Returns the label type. Defined by the constants: {@link #NO_LABELS} and
     * {@link #VALUE_LABELS}.
     *
    ...
    /**
     * Sets the label font and sends a {@link PlotChangeEvent} to all registered
     * listeners.
     *
    ...
    /**
     * Sets the paint used to fill the inner background area of the compass, and
    ...
    /**
     * Sets the count to complete one revolution. Can be arbitrarily set For
     * degrees (the default) it is 360, for radians this is 2*Pi, etc
     *
