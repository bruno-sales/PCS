...
/**
 * Represents state information for the crosshairs in a {@link CategoryPlot}. An
 * instance of this class is created at the start of the rendering process, and
 * updated as each data item is rendered. At the end of the rendering process,
 * this class holds the row key, column key and value for the crosshair
 * location.
 *
 * @since 1.0.11
 */
