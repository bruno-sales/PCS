...
public class ChartViewer extends Control implements Skinnable,
    ...
    /**
     * Returns the flag that controls whether or not tooltips are displayed for
     * the chart.
     *
     * @return A boolean.
     */
    ...
    /**
     * Sets the size and location of the zoom rectangle and makes it visible if
     * it wasn't already visible. The work is delegated to the control's current
     * skin.
     *
