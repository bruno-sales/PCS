...
public class ChartViewerSkin extends SkinBase<ChartViewer> {
    ...
    /**
     * The zoom rectangle is used to display the zooming region when doing a
     * drag-zoom with the mouse. Most of the time this rectangle is not visible.
     */
    ...
    /**
     * Sets the location and size of the zoom rectangle and makes it visible if
