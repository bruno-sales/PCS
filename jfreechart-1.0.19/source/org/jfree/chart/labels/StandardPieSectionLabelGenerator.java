...
public class StandardPieSectionLabelGenerator
     ...
     * <code>null</code> if no attributed label is available (in which case, the
     * string returned by {@link #generateSectionLabel(PieDataset, Comparable)}
     * will provide the fallback). Only certain attributes are recognised by the
     ...
     * current font;</li>
     * <li>{@link TextAttribute#FOREGROUND}: this will set the {@link Paint} for
     * the current</li>
