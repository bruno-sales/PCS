 ...
 * It is recommended you use something like
 ...
 * from disk.
 * <P>
 * SPECIAL NOTE: this class fails to serialize, so if you are relying on your
 * charts to be serializable, please avoid using this class.
 */
public class ImageTitle extends Title {
    ...
    /**
     * Creates a new image title with the given image scaled to the given width
     * and height in the given location.
     *
     * @param image the image ({@code null} not permitted).
    ...
    /**
     * Tests this {@code ImageTitle} for equality with an arbitrary object.
