 ...
 * at the top, left, right or bottom of the chart - a {@code DateTitle} will
...
public class DateTitle extends TextTitle implements Serializable {
     ...
     * {@code LONG} or {@code FULL} (defined in {@code java.util.DateFormat}).
     * <P>
     * For the locale, you can use {@code Locale.getDefault()} for the default
     * locale.
     *
     * @param style the date style.
     ...
     * constants in Title).
     * @param padding determines the blank space around the outside of the title
     * (not null).
     */
    public DateTitle(int style, Locale locale, Font font, Paint paint,
