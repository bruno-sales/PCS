...
public class ShortTextTitle extends TextTitle {
    ...
    /**
     * Performs a layout for this title, subject to the supplied constraint, and
     * returns the dimensions required for the title (if the title cannot be
     * displayed in the available space, this method will return zero width and
     * height for the dimensions).
     *
     ...
     * the height, and returns the required size.
     *
     * @param g2 the graphics target.
     *
