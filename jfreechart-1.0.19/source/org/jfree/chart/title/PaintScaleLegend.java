...
/**
 * A legend that shows a range of values and their associated colors, driven by
 * an underlying {@link PaintScale} implementation.
 *
 * @since 1.0.4
 */
public class PaintScaleLegend extends Title implements AxisChangeListener,
    ...
    /**
     * The axis location (handles both orientations, never <code>null</code>).
     */
    ...
    /**
     * A flag that controls whether or not an outline is drawn around the paint
     * strip.
     */
    ...
    /**
     * Sets the axis for the paint scale and sends a {@link TitleChangeEvent} to
    ...
    /**
     * Sets the width of the paint strip and sends a {@link TitleChangeEvent} to
     * all registered listeners.
     *
    ...
    /**
     * Returns the flag that controls whether or not an outline is drawn around
     * the paint strip.
     *
     * @return A boolean.
     *
    ...
    /**
     * Sets the flag that controls whether or not an outline is drawn around the
     * paint strip, and sends a {@link TitleChangeEvent} to all registered
     * listeners.
     *
    ...
    /**
     * Sets the stroke used to draw the outline around the paint strip and sends
    ...
    /**
     * Sets the subdivision count and sends a {@link TitleChangeEvent} to all
     * registered listeners.
     *
    ...
    /**
     * Receives notification of an axis change event and responds by firing a
     * title change event.
     *
