...
public class TextTitle extends Title
     ...
     * the title's bounding rectangle is aligned within the drawing space.
     *
     ...
     * @param g2 the graphics device.
     * @param area the area.
     * @param params if this is an instance of {@link EntityBlockParams} it is
     * used to determine whether or not an {@link EntityCollection} is returned
     * by this method.
     *
     ...
     * be called from the {@link #draw(Graphics2D, Rectangle2D) draw} method.
     *
     * @param g2 the graphics device.
     * @param area the area for the title.
     */
