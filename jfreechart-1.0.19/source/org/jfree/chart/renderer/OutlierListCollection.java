 ...
 * outliers, determined by whether overlaps have occurred. Overlapping outliers
...
public class OutlierListCollection {
    ...
    /**
     * A flag to indicate the presence of one or more far out values at the top
     * end of the range.
     *
     ...
     * setting the averaged outlier to the average x and y coordinnate values of
     * the outliers in the list.
     *
