...
public abstract class AbstractRenderer implements Cloneable, Serializable {
     ...
     * configure the legend shape as if it were a line.
     *
     * @since 1.0.14
     */
     ...
     * <code>null</code>, the {@link LegendTitle} class will determine the text
     * paint to use.
     *
     * @since 1.0.11
     */
     ...
     * lookupSeriesVisible() to be consistent with the other series attributes
     * and avoid confusion with the getSeriesVisible() method.
     *
     * @param series the series index.
     *
     * @return A boolean.
     ...
     * {@link RendererChangeEvent} to all registered listeners.
     *
     * @param visible the flag (<code>null</code> is permitted, and viewed as
    ...
    public ItemLabelPosition getSeriesPositiveItemLabelPosition(int series) {
        ...
        ItemLabelPosition position = (ItemLabelPosition) this.positiveItemLabelPositionMap.get(series);
        if (position == null) {
    ...
    /**
     * Sets the flag that controls whether or not the legend shape is treated as
     * a line when creating legend items.
     *
     ...
     * @return A clone.
     *
     * @throws CloneNotSupportedException if some component of the renderer does
     * not support cloning.
     */
    @Override
     ...
     * seriesVisibleInLegendList and baseSeriesVisibleInLegend. Deprecated from
     ...
     *
     * @deprecated This field is redundant, you can rely on
     * itemLabelsVisibleList and baseItemLabelsVisible. Deprecated from version
     * 1.0.6 onwards.
     */
     ...
     * positiveItemLabelPositionList and basePositiveItemLabelPosition fields.
     ...
     *
     * @deprecated This field is redundant, you can rely on the
     * negativeItemLabelPositionList and baseNegativeItemLabelPosition fields.
     * Deprecated from version 1.0.6 onwards.
     */
     ...
     *
     * @deprecated This field is redundant, you can rely on the
     * createEntitiesList and baseCreateEntities fields. Deprecated from version
     * 1.0.6 onwards.
     */
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on {@link #setSeriesVisible(int, Boolean)} and
     * {@link #setBaseSeriesVisible(boolean)}.
     */
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on {@link #getSeriesVisibleInLegend(int)} and
     * {@link #getBaseSeriesVisibleInLegend()}.
     */
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on {@link #setSeriesFillPaint(int, Paint)} and
     * {@link #setBaseFillPaint(Paint)}.
     */
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on {@link #setSeriesStroke(int, Stroke)} and
     * {@link #setBaseStroke(Stroke)}.
     */
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on {@link #getSeriesItemLabelPaint(int)} and
     * {@link #getBaseItemLabelPaint()}.
     */
     ...
     * {@link #getSeriesPositiveItemLabelPosition(int)} and
     * {@link #getBasePositiveItemLabelPosition()}.
     */
     ...
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on
     * {@link #setSeriesPositiveItemLabelPosition(int, ItemLabelPosition)} and
     * {@link #setBasePositiveItemLabelPosition(ItemLabelPosition)}.
     */
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on      {@link #setSeriesPositiveItemLabelPosition(int, ItemLabelPosition,
     ...
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on
     * {@link #getSeriesNegativeItemLabelPosition(int)} and
     * {@link #getBaseNegativeItemLabelPosition()}.
     */
     ...
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on
     * {@link #setSeriesNegativeItemLabelPosition(int, ItemLabelPosition)} and
     * {@link #setBaseNegativeItemLabelPosition(ItemLabelPosition)}.
     */
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on      {@link #setSeriesNegativeItemLabelPosition(int, ItemLabelPosition,
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on {@link #getSeriesCreateEntities(int)} and
     * {@link #getBaseCreateEntities()}.
     */
