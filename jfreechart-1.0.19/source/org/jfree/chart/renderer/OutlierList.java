 ...
 *
 * Each list contains an averaged outlier, which is the same as a single outlier
 * if there is only one outlier in the list, but the average of all the outliers
