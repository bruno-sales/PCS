 ...
 * <code>PublicCloneable</code> and <code>Serializable</code>, so that any
 * renderer (or other object instance) that references an instance of this
 * interface can still be cloned or serialized.
 *
 * @since 1.0.4
 */
