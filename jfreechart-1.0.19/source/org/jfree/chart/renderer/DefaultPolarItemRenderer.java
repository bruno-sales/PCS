...
public class DefaultPolarItemRenderer extends AbstractRenderer
    ...
    /**
     * Returns <code>true</code> if the renderer will draw an outline around a
     * filled polygon, <code>false</code> otherwise.
     *
     * @return A boolean.
     *
     * @since 1.0.14
    ...
    /**
     * Set the flag that controls whether the outline around a filled polygon
     * will be drawn or not and sends a {@link RendererChangeEvent} to all
     ...
     *
     * @param composite the composite to use (<code>null</code> not permitted).
     *
     * @since 1.0.14
     */
    ...
    /**
     * Set the flag that controls whether a shape will be drawn for every item,
     * or not and sends a {@link RendererChangeEvent} to all registered
     * listeners.
     *
     ...
     * @param item the item.
     * @param entityX the entity's center x-coordinate in user space (only used
     * if <code>area</code> is <code>null</code>).
     * @param entityY the entity's center y-coordinate in user space (only used
     * if <code>area</code> is <code>null</code>).
     */
