...
/**
 * A paint scale that uses a lookup table to associate paint instances with data
 * value ranges.
 *
 * @since 1.0.4
 */
public class LookupPaintScale
     ...
     * @param defaultPaint the default paint (<code>null</code> not permitted).
     */
    ...
    /**
     * Adds an entry to the lookup table. Any values from <code>n</code> up to
     * but not including the next value in the table take on the specified
     * <code>paint</code>.
     *
