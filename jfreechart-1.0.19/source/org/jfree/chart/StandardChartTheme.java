 ...
 * implementation just collects a whole bunch of chart attributes and mimics the
 * manual process of applying each attribute to the right sub-object within the
 * JFreeChart instance. It's not elegant code, but it works.
 *
 * @since 1.0.11
 */
public class StandardChartTheme implements ChartTheme, Cloneable,
    ...
    /**
     * The paint used to fill the interior of the 'walls' in the background of a
     * plot with a 3D effect. Applied to BarRenderer3D.
     */
    ...
    /**
     * Creates and returns a theme called "Darkness". In this theme, the charts
    ...
    /**
     * Applies the attributes of this theme to a {@link PiePlot} instance. This
     * method also clears any set values for the section paint, outline etc, so
     * that the theme's {@link DrawingSupplier} will be used.
     *
    ...
    /**
     * Applies the attributes of this theme to a {@link PolarPlot}. This method
     * is called from the {@link #applyToPlot(Plot)} method.
     *
     * @param plot the plot (<code>null</code> not permitted).
     */
    ...
    /**
     * Applies the attributes for this theme to a {@link ThermometerPlot}. This
