 ...
 * sorted.
 *
 * @deprecated This class is no longer supported (as of version 1.0.4). If you
 * are creating contour plots, please try to use {@link XYPlot} and
...
public class ClipPath implements Cloneable {
    ...
    /**
     * Controls whether drawing will be clipped ( false would still allow the
     * drawing or filling of path
     */
    ...
    /**
     * Constructor for ClipPath. Default values are assumed for the fillPath and
     * drawPath options as false and true respectively. The fillPaint is set to
     * Color.GRAY, the drawColor is Color.BLUE, the stroke is BasicStroke(1) and
     * the composite is AlphaComposite.Src.
     *
    ...
    /**
     * Constructor for ClipPath. The fillPaint is set to Color.GRAY, the
     * drawColor is Color.BLUE, the stroke is BasicStroke(1) and the composite
     * is AlphaComposite.Src.
     *
     * @param xValue x coordinates of curved to be created
     * @param yValue y coordinates of curved to be created
     * @param clip clip?
