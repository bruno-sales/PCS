...
public class XYPlotTest {
    ...
    /**
     * Renderers that belong to the plot are being cloned but they are retaining
     * a reference to the original plot.
     */
    @Test
    ...
    /**
     * Serialize an instance, restore it, and check for equality. This test uses
     * a {@link DateAxis} and a {@link StandardXYToolTipGenerator}.
     */
    @Test
     ...
     * axesAtBottom, axesAtLeft and axesAtRight - all initialized as empty lists
     * in the constructor) not being initialized by the readObject() method
     * following deserialization. This test has been written to reproduce the
     * bug (now fixed).
     */
    @Test
    ...
    /**
     * Tests a bug where the plot is no longer registered as a listener with the
     * dataset(s) and axes after deserialization. See patch 1209475 at
     * SourceForge.
     */
    @Test
    ...
    /**
     * A test for a bug where setting the renderer doesn't register the plot as
     * a RendererChangeListener.
     */
    @Test
    ...
    /**
     * A test for bug 1654215 (where a renderer is added to the plot without a
     * corresponding dataset and it throws an exception at drawing time).
     */
    @Test
    ...
    /**
     * A test for drawing range grid lines when there is no primary renderer. In
     * 1.0.4, this is throwing a NullPointerException.
     */
    @Test
    ...
    /**
     * A test for drawing a plot where a series has zero items. With JFreeChart
     * 1.0.5+cvs this was throwing an exception at one point.
     */
    @Test
