...
public class BorderArrangementTest {
    ...
    /**
     * This test is for a particular bug that arose just prior to the release of
     * JFreeChart 1.0.10. A BorderArrangement with LEFT, CENTRE and RIGHT blocks
     * that is too wide, by default, for the available space, wasn't shrinking
     * the centre block as expected.
     */
    @Test
