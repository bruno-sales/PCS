...
public class SegmentedTimelineAdditionalTest {
    ...
    /**
     * Test 4 checks 9.30am Friday 26 March 2004 (+ 1 millisecond) converts to a
     * timeline value and back again correctly. This is prior to Daylight
     * Saving.
     */
    @Test
    public void test4() {
    ...
    /**
     * Test 5 checks 5.30pm Thursday 25 March 2004 converts to a timeline value
     * and back again correctly. As it is in the excluded segment, we expect it
     * to map to 9am, Friday 26 March 2004. This is prior to Daylight Saving.
     */
    @Test
    public void test5() {
        TimeZone savedZone = TimeZone.getDefault();
    ...
    /**
     * Creates a timeline from 9am on Thursday 25 March 2004 to 5pm on Tuesday
     * 30 March 2004, for the UK locale.
     *
     * @return A timeline.
     */
