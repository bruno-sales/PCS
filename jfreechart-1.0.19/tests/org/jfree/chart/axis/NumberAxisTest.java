...
public class NumberAxisTest {
    ...
    /**
     * A simple test for the auto-range calculation looking at a NumberAxis used
     * as the range axis for a CategoryPlot.
     */
    @Test
    ...
    /**
     * A simple test for the auto-range calculation looking at a NumberAxis used
     * as the range axis for a CategoryPlot. In this case, the
     * 'autoRangeIncludesZero' flag is set to false.
     */
    @Test
     ...
     * A simple test for the auto-range calculation looking at a NumberAxis used
     * as the range axis for a CategoryPlot. In this case, the
     * 'autoRangeIncludesZero' flag is set to false AND the original dataset is
     * replaced with a new dataset.
     */
    @Test
    ...
    /**
     * A check for the interaction between the 'autoRangeIncludesZero' flag and
     * the base setting in the BarRenderer.
     */
    @Test
    ...
    /**
     * Checks that the auto-range for the domain axis on an XYPlot is working as
     * expected.
     */
    @Test
    ...
    /**
     * Checks that the auto-range for the range axis on an XYPlot is working as
     * expected.
     */
    @Test
