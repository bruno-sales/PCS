...
public class DatasetUtilitiesTest {
    ...
    /**
     * A test for the findRangeBounds(XYDataset) method using an
     * IntervalXYDataset.
     */
    @Test
     ...
     * "cumulative" values are considered to be { 0.0, 10.0, 25.0, 18.0 } so the
     * range should be 0.0 -> 25.0.
     */
    @Test
    ...
    /**
     * Some checks for the iterateToFindRangeBounds() method when applied to a
