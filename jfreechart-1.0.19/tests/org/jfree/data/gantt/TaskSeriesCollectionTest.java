...
public class TaskSeriesCollectionTest {
     ...
     * with two series - the first series has two tasks, but the second has only
     * one. The key is to ensure that the methods in TaskSeriesCollection
     * translate the index values to key values *before* accessing the tasks in
     * the series.
     */
    @Test
