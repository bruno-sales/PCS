...
public class TimeSeriesTest implements SeriesChangeListener {
    ...
    /**
     * Tests a specific bug report where null arguments in the constructor cause
    ...
    /**
     * Some tests to ensure that the createCopy(int, int) method is functioning
     * correctly.
     */
    @Test
    ...
    /**
     * Checks that the min and max y values are updated correctly when copying a
     * subset.
     *
    ...
    /**
     * Create a TimeSeriesDataItem, add it to a TimeSeries. Now, modifying the
     * original TimeSeriesDataItem should NOT affect the TimeSeries.
     */
    @Test
